<?php
    ...
    require_once('../materiais/controller_cautelas_diarias.php');
    ...
    $situacaoCautela = $detalhes->getSituacao();
    $condicao = $detalhes->getDetalhes();
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <?php
                                ...
                                echo "Viatura cautelada: $prefixo<br>";
                                echo "Modelo da viatura: $modelo<br>";
                                echo "Placa da viatura: $placa<br>";
                                echo "Condição da viatura: $situacaoCautela<br>";
                                echo "Situação da viatura: $condicao<br>";
