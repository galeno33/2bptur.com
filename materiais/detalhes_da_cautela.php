<?php
    ...
    $detalhes->detalhesCautela();
    $id = $detalhes->getId1();
    $nomeGuerraCautelante = $detalhes->getGuerraCautelante();
    $nomeGuerraArmeiro = $detalhes->getGuerraArmeiro();
    $postoCautelante = $detalhes->getPostoCautelante();
    $postoArmeiro = $detalhes->getPostoArmeiro();
    $matriculaCautela = $detalhes->getCautela();
    ...
    $diaCautela = date('d-m-Y', strtotime($dataCautela));
    $diaEntrega = $dataEntrega ? date('d-m-Y', strtotime($dataEntrega)) : 'Não devolvido';
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    ...
    <meta name="description" content="Detalhes da Cautela - 2º BPTUR">
    <meta name="author" content="Fabio Galeno">
    <title>Detalhes da Cautela</title>
...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseMaterials" class="collapse" aria-labelledby="headingMaterials" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="historico_de_cautela.php">Histórico de Cautelas</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800 font-weight-bold">Detalhes da Cautela</h1>
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <p><strong>Nome de Guerra (Cautelante):</strong> <?php echo htmlspecialchars($nomeGuerraCautelante); ?> (<?php echo htmlspecialchars($postoCautelante); ?>)</p>
                                </div>
                                <div class="col-md-6">
                                    <p><strong>Armeiro:</strong> <?php echo htmlspecialchars($nomeGuerraArmeiro); ?> (<?php echo htmlspecialchars($postoArmeiro); ?>)</p>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <p><strong>Data da Cautela:</strong> <?php echo htmlspecialchars($diaCautela); ?></p>
                                </div>
                                <div class="col-md-6">
                                    <p><strong>Data da Entrega:</strong> <?php echo htmlspecialchars($diaEntrega); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Modal (Oculto, pois não está sendo usado no código atual, mas mantido para referência) -->
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Confirme sua Matrícula!</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form class="row g-3" action="#" method="POST" novalidate>
                        <div class="col-12">
                            ...
                            <input type="number" class="form-control" name="matricula" id="matriculaToken" value="" disabled>
                        </div>
    ...
    <script>
        // Atualizar notificação de token na topbar (mantido para consistência, embora o token não seja usado aqui)
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (tokenValue && tokenValue !== 'Não aplicável') {
                badge.style.backgroundColor = successColor; // Muda para verde se houver token (não aplicável aqui)
            }
        });
    </script>
</body>
