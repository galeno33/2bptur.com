<?php
    ...
    require_once('detalhesControllerViatura.php');
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <h4>Detalhes da Cautela</h4>
                            <p>Nome de Guerra: <?php echo $guerraCautelante . " (" . $postoCautelante . ")"; ?></p>
                            <p>Armeiro: <?php echo $guerraArmeiro . " (" . $postoArmeiro . ")"; ?></p>
