<?php
    ...
    //$usuario = $_SESSION['matricula'] ?? null; // Garanta que a sessão contém a matrícula
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    ...
    <meta name="description" content="Pedir Permuta - 2º BPTUR">
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800 font-weight-bold">Pedir Permuta</h1>
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Solicitar Permuta</h6>
                        </div>
                        <div class="card-body">
                            <form class="row g-3" id="formPermuta" action="insertPermutar.php" method="POST" novalidate>
                                <div class="col-md-4">
                                    <label for="suaMatricula" class="form-label">Sua Matrícula</label>
                                    <input type="number" class="form-control" name="suaMatricula" id="suaMatricula" placeholder="Digite sua matrícula">
                                    <div class="invalid-feedback">Por favor, informe sua matrícula.</div>
                                </div>
                                <div class="col-md-4">
                                    <label for="matriculaPermutado" class="form-label">Matrícula do Permutado</label>
                                    <input type="number" class="form-control" name="matriculaPermutado" id="matriculaPermutado" placeholder="Digite a matrícula do permutado">
                                    <div class="invalid-feedback">Por favor, informe a matrícula do permutado.</div>
                                </div>
                                <div class="col-md-4">
                                    <label for="dataPermuta" class="form-label">Data da Permuta</label>
                                    <input type="date" class="form-control" name="data_fim" id="dataPermuta">
                                    <div class="invalid-feedback">Por favor, selecione a data da permuta.</div>
                                </div>
                                <div class="col-md-12">
                                    <label for="justificativa" class="form-label">Justificativa</label>
                                    <textarea class="form-control" name="justificativa" id="justificativa" rows="4" placeholder="Digite a justificativa para a permuta"></textarea>
                                    <div class="invalid-feedback">Por favor, informe uma justificativa.</div>
                                </div>
                                <div class="col-12 mt-3">
                                    <button type="submit" name="salvar" class="btn btn-primary">Solicitar Permuta</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Anunciar Permuta</h6>
                        </div>
                        <div class="card-body">
                            <button type="button" class="btn btn-success mb-3" data-toggle="modal" data-target="#announcePermutaModal">Anunciar uma Permuta</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Modal de Anúncio de Permuta -->
    <div class="modal fade" id="announcePermutaModal" tabindex="-1" aria-labelledby="announcePermutaModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="announcePermutaModalLabel">Anunciar Permuta</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form class="row g-3" id="announcePermutaForm" action="../agenda_permuta/agendarPermuta.php" method="POST" novalidate>
                        <input type="hidden" name="suaMatricula" value="<?php echo htmlspecialchars($usuario); ?>">
                        <div class="col-md-12">
                            <label for="dataPermutaAnuncio" class="form-label">Data da Permuta</label>
                            <input type="date" class="form-control" name="dataPermuta" id="dataPermutaAnuncio">
                            <div class="invalid-feedback">Por favor, selecione a data da permuta.</div>
                        </div>
                        <div class="col-md-12 mt-3">
                            <button type="submit" name="salvar" class="btn btn-primary">Anunciar Permuta</button>
    ...
    <script>
        // Validação do formulário de solicitar permuta
        document.getElementById('formPermuta').addEventListener('submit', function(e) {
            let isValid = true;
        ...
        // Validação do formulário de anunciar permuta
        document.getElementById('announcePermutaForm').addEventListener('submit', function(e) {
            let isValid = true;
            const requiredFields = this.querySelectorAll('[required]');
