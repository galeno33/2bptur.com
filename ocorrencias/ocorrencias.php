<?php
    ...
    require_once('selectOcorrencia.php');
    ...
    // Instância do arquivo selectOcorrencia.php
    $ocorrenciaSelect = new SelectOcorrencia($conn);
    $ocorrencia = $ocorrenciaSelect->getOcorrencias();

    // Instância do arquivo usuario/restricaoUsuarios.php
...
<head>
    ...
    <meta name="description" content="Lista de Ocorrências - 2º BPTUR">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800 font-weight-bold">Lista de Ocorrências</h1>
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Ocorrências Registradas</h6>
                        </div>
                        <div class="card-body d-flex flex-column gap-3">
                            <a href="cadastroBo.php" class="btn btn-primary align-self-end">Cadastrar Ocorrências</a>
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Número do BO</th>
                                            <th>Número do Sigo</th>
                                            <th>Tipificação</th>
                                            <th>Data</th>
                                            <th>Ação</th>
                                        </tr>
                                    ...
                                    <tbody>
                                        <?php
                                        foreach ($ocorrencia as $selecionar) {
                                            $id_ranking = $selecionar->getIdOcorrencia();
                                            $matricula_ocorrencia = $selecionar->getMatriculaOcorrencia();
                                            $miker = $selecionar->getMikerOcorrencia();
                                            $sigo = $selecionar->getSigoOcorrencia();
                                            $tipificacao = $selecionar->getTipificacaoOcorrencia();
                                            $dia = $selecionar->getDiaOcorrencia();
                                            $endereco = $selecionar->getEnderecoOcorrencia();
                                            $bairro = $selecionar->getBairroOcorrencia();
                                            $cidade = $selecionar->getCidadeOcorrencia();

                                            // Mapeamento da tipificação
                                            $tipificacaoNome = match ($tipificacao) {
                                                1 => "Furto",
                                                2 => "Roubo",
                                                3 => "Receptação",
                                                4 => "Arma de Fogo",
                                                5 => "Objeto Perfurocortante",
                                                6 => "Entorpecentes",
                                                7 => "Veículo Recuperado",
                                                8 => "Kadron Recuperado",
                                                9 => "Foragido",
                                                10 => "Outras Tipificações",
                                            ...
                                            echo "<tr>";
                                            echo "<td>" . htmlspecialchars($miker) . "</td>";
                                            echo "<td>" . htmlspecialchars($sigo) . "</td>";
                                            echo "<td>" . htmlspecialchars($tipificacaoNome) . "</td>";
                                            echo "<td><strong>" . $diaFormatado . "</strong></td>";
                                            echo "<td>";
                                            echo "<a href='../detalhes/detalheOcorrencias.php?detalheOcorrencia=" . urlencode($id_ranking) . "' class='btn btn-primary btn-sm'>Detalhes</a>";
                                            echo "</td>";
                                            echo "</tr>";
                                        }
                                        ?>
