<?php
    ...
    require_once('autorizado.php');
    session_start();

    $conexao = new Conexao();
    $conn = $conexao->getConexao();

    // Instância do arquivo autorizado.php
    $permutaAutorizada = new Autorizado($conn);
    $autorizado = $permutaAutorizada->getPermutasAutorizadas();
...
<head>
    ...
    <meta name="description" content="Permutas Autorizadas - 2º BPTUR">
    <meta name="author" content="Fabio Galeno">
    <title>Permutas Autorizadas</title>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseAdmin" class="collapse" aria-labelledby="headingAdmin" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <?php if ($funcao == "Cmd de Cia") { ?>
                                <a class="collapse-item" href="permuta_a_autorizar.php">Permuta a Autorizar</a>
                            <?php } ?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800 font-weight-bold">Permutas Autorizadas e Negadas</h1>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Permutas Autorizadas e Negadas</h6>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <?php
                                                foreach ($autorizado as $permutado) {
                                                    $id = $permutado->getId();
                                                    $matrPermutante = $permutado->getMatrPermutante();
                                                    $guerraPermutante = $permutado->getGuerraPermutante();
                                                    $guerraPermutado = $permutado->getGuerraPermutado();
                                                    $matrPermutado = $permutado->getMatrPermutado();
                                                    $dataPermuta = $permutado->getDataPermuta();
                                                    $aceitoPermuta = $permutado->getAceitoPermuta();
                                                    $autorizacaoPermuta = $permutado->getAutorizacaoPermuta();
                                                    $cia = $permutado->getCia();
                                                    ...
                                                    if ($aceitoPermuta == "Confirmado") {
                                                        ...
                                                        echo "<td>" . htmlspecialchars($autorizacaoPermuta) . "</td>";
