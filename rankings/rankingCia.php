<?php
    ...
    require_once('selectRankingCia.php');
    ...
    $rankingCia = new RankingCia();
    $rankings = $rankingCia->rankingCia();
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
    ...
    <meta name="description" content="Ranking por Companhia - 2º BPTUR">
    <meta name="author" content="Fabio Galeno">
    <title>Ranking por Companhia</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-4 text-gray-800 font-weight-bold">Ranking por Companhia</h1>
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Ranking da <?php echo htmlspecialchars($cia); ?>ª Companhia</h6>
                        </div>
                        <div class="card-body">
