    ...
    <script>
       /** let contadorMatriculas = 0;
        ...
        function adicionarMatricula() {
            ...
            // Cria novos campos dinamicamente
            let novoCampo = `
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">BPTUR <sup>1</sup></div>
            </a>
                ...
                <div class="container-fluid">
                    ...
                    <!--<div class="row">-->
                        ...
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Adicone as matriculas dos operadores</h5>
                                <button style="margin: 0 auto; text-align: center; position: relative;" type="button" class="btn btn-primary" onclick="adicionarMatricula()">Adicionar Matrícula</button>
                                    <form class="row g-6">
                                ...
                                <a href="cadastroBo.php" class="btn btn-primary" onclick="adosAdicionados()">Ok</a>
