        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!--<div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">GRAFICOS ESTATISTICOS</h1>
                    
                    
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">ESCOLHA O CPAM</h6>
                        </div>
                        <div class="section-content">
                            <div class="card-body">
                                
                                <div class="col-12 col-md-6 col-lg-6" id="primeiraEscolha">
                                    <label for="tipoDeGrafico" class="form-label">Tipo de gráficos</label>
                                    <select class="form-control form-control-lg" id="tipoDeGrafico">
                                        <option selected disabled>Tipo de gráficos</option>
                    ...
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary text-center">CPAMS</h6>
                    </div>
                    ...
                    <div class="form-group mt-3 px-3">
                        <label for="selectCpam" class="form-label">Selecionar CPAM</label>
                        <select class="form-control" id="selectCpam">
                            <option value="CPAM-NORTE">CPAM-NORTE</option>
                            <option value="CPAM-SUL">CPAM-SUL</option>
                            <option value="CPAM-LESTE">CPAM-LESTE</option>
                            <option value="CPAM-OESTE">CPAM-OESTE</option>
                        </select>
                    </div>
                    <div class="card-body">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="porCpam-tab" data-toggle="tab" href="#" role="tab" aria-controls="porCpam" aria-selected="true">Por Cpam</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="porUnidade-tab" data-toggle="tab" href="#" role="tab" aria-controls="porUnidade" aria-selected="false">Por Unidade</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="porGrupoCrime-tab" data-toggle="tab" href="#" role="tab" aria-controls="porGrupoCrime" aria-selected="false">Grupos de crimes</a>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="porCpam" role="tabpanel" aria-labelledby="porCpam-tab"> CPAM</div>
                    <div class="tab-pane fade" id="porUnidade" role="tabpanel" aria-labelledby="porUnidade-tab">UNIDADE</div>
                    <div class="tab-pane fade" id="porGrupoCrime" role="tabpanel" aria-labelledby="porGrupoCrime-tab">GRUPO</div>
                </div>
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">=====================GRÁFICOS ESTATÍSTICOS=========================</h1>

                    

                    <!-- Escolha do Tipo de Crime -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">SELECIONE O TIPO DE CRIME</h6>
                        </div>
                         <!---por cpam, por batalhão, por grupos de crime----->
                            <div class="card-body">
                                <div class="col-12 col-md-6 col-lg-6">
                                    <label for="tipoDeGrafico" class="form-label">Tipo de gráficos</label>
                                    <select class="form-control form-control-lg" id="tipoDeGrafico">
                                        <option selected disabled>Selecione o tipo de crime</option>
                                        <option value="1">Por CPAM</option>
                                        <option value="2">Por Unidades</option>
                                        <option value="3">Por Grupos de crimes</option>
                                    </select>
                                </div>
                            
                            
                                <!--<div class="card-body">-->
                                <div class="col-12 col-md-6 col-lg-6" style="display:none;" id="porCpam">
                                ...
                                <div class="col-12 col-md-6 col-lg-6" style="display:none;" id="porGrupoCrime">
                    ...
                    <!-- Escolha do CPAM e BPM -->
                    <!--<div class="card shadow mb-4" style="display: none;" id="selecionarCpamBpm">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">SELECIONE O CPAM E BPM</h6>
                        </div>
                        <div class="card-body">-->
                            <!-- Seleção de CPAM -->
                           <!-- <div class="form-group">
                                <label for="selectCpam" class="form-label">Selecionar CPAM</label>
                                <select class="form-control" id="selectCpam">
                                    <option selected disabled>Escolha o CPAM</option>
                                    <option value="CPAM-NORTE">CPAM-NORTE</option>
                                    <option value="CPAM-SUL">CPAM-SUL</option>
                                    <option value="CPAM-LESTE">CPAM-LESTE</option>
                                    <option value="CPAM-OESTE">CPAM-OESTE</option>
                            ...
                            <!-- Seleção de BPM -->
                            <!--<div class="form-group mt-3" id="selectBpmContainer" style="display: none;">
                                <label for="selectBpm" class="form-label">Selecionar BPM</label>
                                <select class="form-control" id="selectBpm">
                                    <option selected disabled>Escolha o BPM</option>-->
                                    <!-- Opções de BPM serão preenchidas dinamicamente -->
                                <!--</select>
                            </div>
                        </div>
                    <</div>-->
