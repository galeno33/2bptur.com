                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="chart-area">
                                        ...
                                        <form class="row g-3" id="cadastroUsuario" method="POST" enctype="multipart/form-data">
                                            <div class="col-9">
                                            ...
                                            <div class="col-3">
                                                ...
                                                <input type="text" class="form-control" name="posto" id="inputPosto" value="<?php echo $posto;?>" style="text-transform: uppercase;">
                                            </div>
                                            <div class="col-3">
